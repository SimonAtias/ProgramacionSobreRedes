...
INSERT INTO `funciones` VALUES (1,'Ciudadano Kane','2020-04-13 19:30:00',1,'[\"a1\", \"a4\", \"b2\", \"c1\"]',1,'citizen_kane.jpg'),(3,'El Padrino','2020-07-24 21:00:00',2,'[]',0,'the_godfather.jpg'),(4,'Lo que el viento se llevó','2021-08-01 15:45:00',1,'[\"a3\", \"a4\", \"b1\", \"b2\", \"b3\", \"b4\", \"c2\", \"c3\", \"c4\", \"d1\", \"d2\", \"d3\", \"f1\"]',1,'gone_with_the_wind.jpg');
...
CREATE TABLE `reservas` (
  ...
  CONSTRAINT `reserva_usuario` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`id`)
...
-- Dump completed on 2021-07-13 12:45:24
